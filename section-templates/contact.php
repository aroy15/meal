                ...
                <form action="#">
                    ...
                    <div class="row mb-4">
                        <div class="form-group col-md-4">
                            <label for="cname" class="label"><?php _e('Name', 'meal');?></label>
                        ...
                        <div class="form-group col-md-4">
                            <label for="cemail" class="label"><?php _e('Email', 'meal');?></label>
                            <div class="form-field-icon-wrap">
                                <span class="icon ion-email"></span>
                                <input type="cemail" class="form-control" id="email">
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="cphone" class="label"><?php _e('Phone', 'meal');?></label>
                            <div class="form-field-icon-wrap">
                        ...
                        <div class="form-group col-md-12">
                            <label for="cmessage" class="label"><?php _e('Message', 'meal');?></label>
                            <textarea name="message" id="cmessage" cols="30" rows="10" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-md-4">
                            <input type="submit" id="send-message" class="btn btn-primary btn-outline-primary btn-block" value="<?php _e('Send Message', 'meal');?>">
                        </div>
                    </div>
                </form>
            </div>
