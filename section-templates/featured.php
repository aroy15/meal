        ...
        <div class="row">
            ...
            <div class="ftco-46">
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                    <div class="ftco-46-image" style="background-image: url(<?php echo get_the_post_thumbnail_url($meal_recipe_one, "large"); ?>);"></div>
                    <div class="ftco-46-text ftco-46-arrow-left">
                        <h4 class="ftco-46-subheading">
                            <?php
                            echo esc_html(get_recipe_category($meal_recipe_one->ID));
                            ?>
                        </h4>
                    ...
                    <div class="ftco-46-image" style="background-image: url(<?php echo get_the_post_thumbnail_url($meal_recipe_two, "large"); ?>);"></div>
                </div>
                ...
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                    <div class="ftco-46-text ftco-46-arrow-right">
                        <h4 class="ftco-46-subheading">
                            <?php
                            echo esc_html(get_recipe_category($meal_recipe_two->ID));
                            ?>
                        </h4>
                    ...
                    <div class="ftco-46-image" style="background-image: url(<?php echo get_the_post_thumbnail_url($meal_recipe_three, "large"); ?>);"></div>
                    <div class="ftco-46-text ftco-46-arrow-up">
                        <h4 class="ftco-46-subheading">
                            <?php
                            echo esc_html(get_recipe_category($meal_recipe_three->ID));
                            ?>
                        </h4>
