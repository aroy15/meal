...
if(isset($meal_section_meta['banner_image'])){
    $meal_banner_image = wp_get_attachment_image_url($meal_section_meta['banner_image'], 'full');
}
...
<div class="cover_1 overlay bg-slant-white bg-light">
    <div class="img_bg" style="background-image: url(<?php echo esc_url($meal_banner_image); ?>);" data-stellar-background-ratio="0.5">
        <div class="container">
